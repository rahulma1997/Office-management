...
const ProjectTable = () => {
  ...
  const projectadd = async (e) => {
    ...
    try {
      await axios.post("http://localhost:5000/projects/", projectformData);
      fetchProject();
      handleClose();
  ...
  const updateProject = async (e) => {
    ...
    try {
      await axios.put(
        `http://localhost:5000/projects/${editProjectId}`,
        updatedProjectData
      );
      fetchProject();
      handleClose();
  ...
  const AssignProject = async (e) => {
    ...
    try {
      await axios.post("http://localhost:5000/task/add", AssignAdmin);
      handleClose1();
