  ...
  const UserForm = async (e) => {
    ...
    try {
      if (isEdit) {
        ...
        await axios.put(`http://localhost:5000/users/userID/${userformData.userID}`, userformData);
        toast.success("User Data updated successfully!");
      } else {
       
        await axios.post("http://localhost:5000/users/", userformData);
      }
      fetchUsers();
      handleClose3();
    ...
    <>
            ...
            <table className="min-w-full border-collapse border border-gray-300">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="border border-gray-300 p-2 text-left">Designation/Role</th>
                  <th className="border border-gray-300 p-2 text-left">Joining Date</th>
                  <th className="border border-gray-300 p-2 text-left">Status</th>
                  <th className="border border-gray-300 p-2 text-left">Profile Picture</th>
              ...
              <tbody>
                {currentItems.map((user, index) => (
                  <tr key={user.userID} className="bg-slate-100">
                    <td className="border border-gray-300 p-2">{(currentPage - 1) * pageSize + index + 1}</td>
                    ...
                    <td className="border border-gray-300 p-2">{new Date(user.joiningDate).toLocaleDateString()}</td>
                    ...
                    <td className="border border-gray-300 p-2">
                      <button className="text-blue-500 hover:underline" onClick={() => editUser(user)}>
                        Edit
                      </button>
                      <button
      ...
      <Dialog open={open3} onClose={handleClose3}>
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-2 text-center">{isEdit ? "Edit User" : "Add New User"}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-1">
              <div className="mb-1">
                ...
                <input
                  ...
                  onChange={(e) => setUserData({ ...userData, joiningDate: e.target.value })}
                />
              </div>
              <div className="mb-1">
